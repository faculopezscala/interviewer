...
class BaseRecorder:
    ...
    def record_into_queue(self, audio_queue):
        ...
        print(f"[INFO] Starting background listening on {self.source_name}")
            ...
            with pyaudio.PyAudio() as p:
                ...
                if not default_speakers["isLoopbackDevice"]:
                    for loopback in p.get_loopback_device_info_generator():
                        ...
                        return
                print(f"[INFO] Default speaker device found: {default_speakers['name']}")
        else:
            p = pyaudio.PyAudio()
...
# Additional code for initializing recorders and putting them into use
# would go here, such as creating an audio queue and starting the recording process.
